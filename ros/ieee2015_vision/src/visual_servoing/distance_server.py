...
def handle_two_points(req):
    ...
    xcomp1=((end_camera_x)+(1.0/840)*(end_camera_height+0.21658-req.point2.z)*(req.point1.x - req.point2.x))
    ycomp1=((end_camera_y+0.02073)+(1.0/840)*(end_camera_height+0.21658-req.point2.z)*(req.point1.y - req.point2.y))
...
if __name__== "__main__":
    ...
    rospy.init_node('ieee2015_tf_broadcaster2')
