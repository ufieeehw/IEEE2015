...
#	        cv2.circle(dst,(i[0],i[1]),2,(0,0,255),3)
	...
	return p1CentMajor, p2CentMajor, p1CentMinor, p2CentMinor, quarterMin1, quarterMin2, quarterMaj1, quarterMaj2
...
getAxisPoints(img2)
	...
	#majorVal, minorVal = determineSide.determineSide(p1CentMajor, p2CentMajor, p1CentMinor, p2CentMinor, (520,333), angle)
