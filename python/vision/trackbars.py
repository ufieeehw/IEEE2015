...
'''this is just a handy dandy way for finding hsv ranges, simply stick in the image you want to find ranges for and go'''
...
img = cv2.imread('Images/Set2/sbright1.JPG')
